...
const string BaseClientAPI::Attachment::Audio::type = "audio";
const string BaseClientAPI::Attachment::Photo::type = "photo";
const string BaseClientAPI::Attachment::Document::type = "doc";

bool BaseClientAPI::Attachment::BaseAttachment::parse_type(const json &data) {
    try {
...
bool BaseClientAPI::Attachment::BaseAttachment::parse_common(const json &data) {
    try {
...
bool BaseClientAPI::Attachment::Audio::parse(const json &data) {
    if(data == nullptr) {
        return false;
    }
...
bool BaseClientAPI::Attachment::Photo::parse(const json &data) {
...
std::string BaseClientAPI::Attachment::Document::doc_type_str(const int tp) {
    switch (tp) {
    case 1:
        return "text";
    case 2:
...
bool BaseClientAPI::Attachment::Document::parse(const json &data) {
    if(data == nullptr) {
        return false;
    }
...
bool BaseClientAPI::Attachment::User::parse(const BaseClientAPI::json &data) {
    if(data == nullptr) {
        return false;
    }
