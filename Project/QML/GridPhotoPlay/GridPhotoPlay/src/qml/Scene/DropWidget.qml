...
Item {
    ...
    Rectangle {
        ...
        TableView {
            ...
            //                }
            delegate: Item {
                id:backgound_tile_container
                implicitHeight:1
                implicitWidth:1
                // preventStealing: true
                Rectangle {
                    id: background_tile_rectangle
                    //anchors.fill: parent
                    ...
                    Image {
                        ...
                        id: backgound_hovered_image
                        // anchors.fill: parent
                        //toDo
                        source: image_source//background_source//model.image_source
                        anchors {
                            horizontalCenter: parent.horizontalCenter;
                            verticalCenter: parent.verticalCenter
                        }
                    ...
                    MouseArea {
                        id: mouse_area
                        anchors.fill: parent
                        drag.target: backgound_tile_container
                        hoverEnabled:true
                        ...
                        DropArea {
                            ...
                            anchors.fill: parent
                            onEntered: {
                                console.log("DropArea onEntered"+background_tile_rectangle.originID)
                            }
                            onDropped: {
                                console.log("DropArea onDropped"+background_tile_rectangle.originID)
                            }
                        }
                        states: [
                            State {
                                ...
                                PropertyChanges {
                                    target: backgound_hovered_image
                                    visible: true
                                }
                                PropertyChanges {
                                    target: backgound_border
                                    visible: false
                                }
                            }
                        ]
                        onEntered: {
                            console.log(background_tile_rectangle.originID)
                        }
                        onReleased: {
                            console.log("onReleased"+background_tile_rectangle.originID)
                        }
                    }

                    Component.onCompleted: {
                        background_tile_rectangle.parent = root;
                        background_tile_rectangle.x = background_tile_rectangle.originX;
                        background_tile_rectangle.y = background_tile_rectangle.originY;
                        background_tile_rectangle.width = backgound_icon.paintedWidth
                        background_tile_rectangle.height = backgound_icon.paintedHeight
                        // background_tile_rectangle.parent = backgound_tile_container;
                    }
                }
            }
        }
