...
ParseServiceText:: ParseServiceText(WorkerBaseClass *m_worker, CLIENT_TYPE const & m_type):ParseServiceBaseClass(m_worker, m_type)
{
...
void ParseServiceText:: create_connect_to_worker()
{
    //send data to worker
    //qDebug()<< "ParseServiceText::create_connect_to_worker";
...
QStringList ParseServiceText::sl_parse_line(QString  const message )
{
