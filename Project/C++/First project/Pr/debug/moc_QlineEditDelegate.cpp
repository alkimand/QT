/****************************************************************************
** Meta object code from reading C++ file 'QlineEditDelegate.h'
**
...
#error "The header file 'QlineEditDelegate.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_LineEditDelegate_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_LineEditDelegate_t qt_meta_stringdata_LineEditDelegate = {
    {
QT_MOC_LITERAL(0, 0, 16), // "LineEditDelegate"
QT_MOC_LITERAL(1, 17, 20), // "commitAndCloseEditor"
QT_MOC_LITERAL(2, 38, 0), // ""
QT_MOC_LITERAL(3, 39, 14) // "emitCommitData"

    },
    "LineEditDelegate\0commitAndCloseEditor\0"
    "\0emitCommitData"
};
...
void LineEditDelegate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->emitCommitData(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
QT_INIT_METAOBJECT const QMetaObject LineEditDelegate::staticMetaObject = { {
    &QItemDelegate::staticMetaObject,
    qt_meta_stringdata_LineEditDelegate.data,
    qt_meta_data_LineEditDelegate,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *LineEditDelegate::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_LineEditDelegate.stringdata0))
