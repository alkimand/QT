...
QT_MOC_LITERAL(3, 28, 14), // "slotReadServer"
QT_MOC_LITERAL(4, 43, 14), // "clearTextField"
QT_MOC_LITERAL(5, 58, 16), // "SetChekBxNeebZip"
QT_MOC_LITERAL(6, 75, 17) // "SetChekBxNeebCode"

    },
    "MyClient\0slotNewConnection\0\0slotReadServer\0"
    "clearTextField\0SetChekBxNeebZip\0"
    "SetChekBxNeebCode"
};
...
void MyClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->slotReadServer(); break;
        case 2: _t->clearTextField(); break;
        case 3: _t->SetChekBxNeebZip((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 4: _t->SetChekBxNeebCode((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
    }
}
