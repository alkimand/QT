...
Item {
	...
	enum OneRowItemType {
		...
		ONE_TEXT_LEFT_TEXT_AND_DATE_COMBOBOX_ONLY_LEFT_COMBOBOX_ALIGNEMENT = 7,
		ONE_TEXT_LEFT_TEXT_AND_DATE_COMBOBOX_ONLY_RIGHT_COMBOBOX_ALIGNEMENT = 8,
        TWO_TEXT_LEFT_TEXT_AND_LABEL_ONLY = 9,		
