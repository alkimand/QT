...
Item {
    ...
    width:settingData.appContentWidgetSettings.contentCalculatorPageWidth/2
    height:settingData.appContentWidgetSettings.buttonHeight //border
...
//        property string  textFirstLine: "QT"
        ...
        palette {
            button: "white"//settingData.columnSettings.columnFreeSpaceColor
            //mid : "red"
            //midlight: "black"
        }
